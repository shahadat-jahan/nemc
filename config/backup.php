...
//                    base_path(),
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => 'protik.hore@vivasoftltd.com',
            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'no-reply@nemc.edu.bd'),
                'name' => env('MAIL_FROM_NAME', 'NEMC'),
            ],
        ],
