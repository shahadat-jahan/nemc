                                            ...
                                            <div class="m-portlet__body">
                                                <div class="m-card-profile">
                                                    ...
                                                    <div class="m-card-profile__details">
                                                        ...
                                                        <span class="m-card-profile__name">{{!empty($parentInfo->father_name) ? $parentInfo->father_name :''}}</span>
                                    ...
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    <td><a href="{{route('students.show', $student->id)}}" target="_blank">{{$student->full_name_en}}</a></td>
