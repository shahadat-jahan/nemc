    ...
    <div class="m-portlet m-portlet--tab">
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text"><i class="far fa-plus-square pr-2"></i>Add New Applicants</h3>
                </div>
            </div>
        ...
        <div class="m-wizard m-wizard--2 m-wizard--success" id="m_wizard">
            ...
            <div class="m-wizard__form">
                <form action="{{route('admission.store')}}" method="post" class="m-form m-form--label-align-left- m-form--state-" id="nemc_wizard_form">
                @csrf
                <!--begin: Form Body -->
                    <div class="m-portlet__body">
                        ...
                        <div class="m-wizard__form-step m-wizard__form-step--current" id="m_wizard_form_step_1">
                            @include('admission.applicant_add')
                        </div>
                        <!--end: Form Wizard Step 1-->

                        <!--begin: Form Wizard Step 2-->
                        <div class="m-wizard__form-step" id="m_wizard_form_step_2">
                            @include('admission.applicant_address_add')
                        </div>
                        <!--begin: Form Wizard Step 2-->

                        <!--begin: Form Wizard Step 3-->
                        <div class="m-wizard__form-step" id="m_wizard_form_step_3">
                            @include('admission.applicant_parents_add')
                        </div>
                        <!--end: Form Wizard Step 3-->

                        <!--begin: Form Wizard Step 4-->
                        <div class="m-wizard__form-step" id="m_wizard_form_step_4">
                            @include('admission.applicant_education_add')
                        </div>
...
@push('scripts')
    ...
    <script>
                    ...
                    $("#m_wizard"),
                        ...
                        e=i.validate( {
                                ...
                                rules: {
                                    ...
                                    father_user_id: {
                                        required: function (){
                                            return $('#parent-exist').is(':checked');
                                        }
                                    },
                                    father_name: {
                                        required: true,
        ...
        $(document).ready(function() {
            ...
            $('#parent-exist').click(function () {
                if ($(this).is(':checked')){
                    $('.hide-parent-id').removeClass('m--hide')
                } else{
                    $('.hide-parent-id').addClass('m--hide')
                }
            });
