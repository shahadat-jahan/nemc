<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('emergency_contact_name') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="emergency_contact_name"
                   value="{{$applicant->admissionEmergencyContact->full_name ?? ''}}" placeholder="Name"/>
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('emergency_contact_relation') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="emergency_contact_relation"
                   value="{{$applicant->admissionEmergencyContact->relation ?? ''}}" placeholder="Relation"/>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('emergency_phone') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="emergency_phone"
                   value="{{$applicant->admissionEmergencyContact->phone ?? ''}}" placeholder="Phone"/>
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('emergency_email') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="emergency_email"
                   value="{{$applicant->admissionEmergencyContact->email ?? ''}}" placeholder="Email"/>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <div class="form-group  m-form__group {{ $errors->has('emergency_address') ? 'has-danger' : '' }}">
            ...
            <textarea class="form-control m-input" name="emergency_address" rows="3"
                      placeholder="Address">{{$applicant->admissionEmergencyContact->address ?? ''}}</textarea>
