...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group m-form__group {{ $errors->has('admission_year') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input m_year_picker" name="admission_year" value="{{date('Y')}}"/>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('form_fillup_date') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input m_datepicker_1" name="form_fillup_date" placeholder="Form Fillup Date" autocomplete="off"/>
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('commenced_year') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input m_year_picker" name="commenced_year" value="{{date('Y')}}"/>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('date_of_birth') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input m_datepicker_1" name="date_of_birth" placeholder="Date of birth" autocomplete="off"/>
