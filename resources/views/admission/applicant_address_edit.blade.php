<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('nationality') ? 'has-danger' : '' }}">
            ...
            <select class="form-control m-input m-bootstrap-select m_selectpicker" name="nationality" data-live-search="true">
                ...
                {!! select($countries, $applicant->nationality) !!}
            </select>
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('place_of_birth') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="place_of_birth" value="{{$applicant->place_of_birth}}" placeholder="Place of birth"/>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('mother_tongue') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="mother_tongue" value="{{$applicant->mother_tongue}}" placeholder="Mother tongue"/>
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('knowledge_english') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="knowledge_english" value="{{$applicant->knowledge_english}}" placeholder="Knowledge of English"/>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <div class="form-group  m-form__group {{ $errors->has('permanent_address') ? 'has-danger' : '' }}">
            ...
            <textarea class="form-control m-input" name="permanent_address" id="st-permanent-addr" rows="3" placeholder="Permanent address" autocomplete="off">{{$applicant->permanent_address}}</textarea>
        ...
        <div class="form-group  m-form__group {{ $errors->has('present_address') ? 'has-danger' : '' }}">
            ...
            <div class="m-checkbox-list">
                <label class="m-checkbox">
                    <input type="checkbox" name="same_as_present" id="same_as_present" value="1" {{($applicant->same_as_permanent) ? 'checked' : ''}}> Same as permanent address
                    <span></span>
                </label>
            </div>
            <textarea class="form-control m-input" name="present_address" id="st-present-addr" rows="3" placeholder="Present address" autocomplete="off" {{($applicant->same_as_permanent) ? 'readonly' : ''}}>{{$applicant->present_address}}</textarea>
