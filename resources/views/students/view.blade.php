            ...
            <div class="m-portlet view-page">
                <div class="m-portlet__head">
                    ...
                    <div class="m-portlet__head-tools">
                        <a href="{{ route('students.index') }}" class="btn btn-primary m-btn m-btn--icon" title="Applicants"><i class="fa fa-list"></i> Students</a>
                    </div>
                </div>
                            ...
                            <div class="m-portlet m-portlet--full-height  ">
                                <div class="m-portlet__body">
                                    <div class="m-card-profile">
                                        ...
                                        <div class="m-card-profile__pic">
                                            <div class="m-card-profile__pic-wrapper">
                                                ...
                                                @else
                                                    <img src="{{ $student->gender == 'male' ? asset('assets/global/img/male_avater.png') : asset('assets/global/img/female_avater.png')}}" alt="Applicant image">
                                                @endif
                                            </div>
                                        </div>
                                        <div class="m-card-profile__details">
                                            ...
                                            <a href="" class="m-card-profile__email m-link">{{ $student->email }}</a>
                                            @endif
                                        </div>
                                    </div>
                                    <ul class="m-nav m-nav--hover-bg m-portlet-fit--sides">
                                        ...
                                        <li class="m-nav__item">
                                            <div class="m-nav__link">
                                                <i class="m-nav__link-icon fas fa-user"></i>
                                                <span class="m-nav__link-text">Reg: {{!empty($student->reg_no) ? $student->reg_no : 'N/A'}}</span>
                                            </div>
                                        </li>
                                        <li class="m-nav__item">
                                            <div class="m-nav__link">
                                        ...
                                        @if($student->status == 5)
                                        <li class="m-nav__item">
                                            <a class="m-nav__link" href="{{route('students.testimonial', [$student->id])}}">
                                    ...
                                    <div class="m-portlet__head-tools">
                                        <ul class="nav nav-tabs m-tabs m-tabs-line m-tabs-line--left m-tabs-line--primary" role="tablist">
                                            <li class="nav-item m-tabs__item">
                                                <a class="nav-link m-tabs__link active show" data-toggle="tab" href="#personal_info" role="tab" aria-selected="true">
                                                    <i class="flaticon-share m--hide"></i>
                                                    Personal
                                                </a>
                                            </li>
                                            <li class="nav-item m-tabs__item">
                                                <a class="nav-link m-tabs__link" data-toggle="tab" href="#admission_info" role="tab" aria-selected="false">
                                                    Admission
                                                </a>
                                            </li>
                                            <li class="nav-item m-tabs__item">
                                                <a class="nav-link m-tabs__link" data-toggle="tab" href="#education_info" role="tab" aria-selected="false">
                                                    Education
                                                </a>
                                            </li>
                                            ...
                                            <li class="nav-item m-tabs__item">
                                                <a class="nav-link m-tabs__link" data-toggle="tab" href="#parent_asset_info" role="tab" aria-selected="false">
                                                    Parent's Asset
                                                </a>
                                            </li>

                                            <li class="nav-item m-tabs__item">
                                                <a class="nav-link m-tabs__link" data-toggle="tab" href="#contact_info" role="tab" aria-selected="false">
                                                    Contact
                                                </a>
                                            </li>

                                            <li class="nav-item m-tabs__item">
                                                <a class="nav-link m-tabs__link" data-toggle="tab" href="#attachment_info" role="tab" aria-selected="false">
                                                    Attachment
                                                </a>
                                            </li>
                                        </ul>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active show" id="personal_info">
                                        <div class="row pt-4 pl-2 pr-2">
                                            <div class="col-md-12">
                                                <div class="m-list-search__result-category"><h5 class="text-center pb-2">Personal Information</h5></div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="card mb-2">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-6"> <p>Admission Session : {{$student->session->title}}</p></div>
                                                            <div class="col-md-6"> <p>Present Session : {{$student->followedBySession->title}}</p></div>
                                                            <div class="col-md-6"> <p>Course : {{$student->course->title}}</p></div>
                                                            <div class="col-md-6"><p>Gender : {{$student->gender}}</p></div>
                                                            <div class="col-md-6"><p>Date of Birth : {{$student->date_of_birth}}</p></div>
                                                            <div class="col-md-6"><p>Birth Place: {{$student->place_of_birth}}</p></div>
                                                            <div class="col-md-6"><p>Available Credit <small>(for tuition)</small>: {{($student->student_category_id == 2) ? 'USD' : 'Tk'}} {{formatAmount($student->available_amount_for_tuition)}}</p></div>
                                                            <div class="col-md-6"><p>Available Credit <small>(for development)</small>: {{($student->student_category_id == 2) ? 'USD' : 'Tk'}} {{formatAmount($student->available_amount_for_development)}}</p></div>
                                                        </div>
                                                        ...
                                                        <p class="mb-0"> <b>Address</b> : {{ isset($student->address) ? $student->address : 'N/A' }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            <td><a href="{{route('guardians.show', [$student->parent->id])}}">{{$student->parent->father_name}}</a></td>
                                                            <td><a href="{{route('guardians.show', [$student->parent->id])}}">{{$student->parent->mother_name}}</a></td>
                                                            <td>{{$student->parent->father_phone}}</td>
                                                            <td>{{$student->parent->mother_phone}}</td>
                                                            <td><a href="mailto:{{$student->parent->father_email}}">{{$student->parent->father_email}}</a></td>
                                                            <td><a href="mailto:{{$student->parent->mother_email}}">{{$student->parent->mother_email}}</a></td>
                                                        </tr>
                                                        <tbody>
                                    ...
                                    <div class="tab-pane" id="admission_info">
                                        <div class="row pt-4 pl-2 pr-2">
                                            <div class="col-md-12">
                                                <div class="m-list-search__result-category mb-2"><h5 class="text-center pb-2">AdmisAdon Information</h5></div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                    ...
                                    <div class="tab-pane" id="attachment_info">
                                        <div class="row pt-4 pl-2 pr-2">
                                            <div class="col-md-12">
                                                <div class="m-list-search__result-category"><h5 class="text-center pb-2">Attachments</h5></div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        ...
                                                        @foreach($student->attachments as $attachment)
                                                            <tr>
                                                                ...
                                                                <td><a href="{{asset($attachment->file_path)}}" target="_blank"><i class="fa fa-download"></i></a></td>
                                                            </tr>
                                                        @endforeach
                                                        <tbody>
