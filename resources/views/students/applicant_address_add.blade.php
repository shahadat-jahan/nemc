...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <div class="form-group  m-form__group {{ $errors->has('permanent_address') ? 'has-danger' : '' }}">
            ...
            <textarea class="form-control m-input" name="permanent_address" id="st-permanent-addr" rows="3" placeholder="Permanent address"></textarea>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <div class="form-group  m-form__group {{ $errors->has('present_address') ? 'has-danger' : '' }}">
            ...
            <textarea class="form-control m-input" name="present_address" id="st-present-addr" rows="3" placeholder="Present address"></textarea>
