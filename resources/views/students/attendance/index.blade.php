                            ...
                            <div class="m-portlet m-portlet--full-height  ">
                                <div class="m-portlet__body">
                                    ...
                                    <ul class="m-nav m-nav--hover-bg m-portlet-fit--sides">
                                        ...
                                        <li class="m-nav__item ">
                                            <a class="m-nav__link active-link" href="{{route('students.attendance', [$student->id])}}">
                                            ...
                                            @if($phase->phase_id == $student->phase_id)
                                                @foreach($subjects as $subject)
                                                    ...
                                                    if (Auth::guard('web')->check()){
                                                        ...
                                                        if ($user->teacher){
                                                            if (!in_array($subject->id, getSubjectsIdByTeacherId($user->teacher->id, $user->teacher->course_id))){
                                                                $hideClass = 'm--hide';
                                                            }
                                                        }
                                                    }
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                                    <div class="card">
                                                                        <div class="card-body">
                                                                            <div class="row">
                                                                                <h5 class="text-center w-100">Tutorial Percentage</h5>
                                                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                                                    <div class="m-widget24 card">
                                                                                        <div class="m-widget24__item">
                                                                                            <h4 class="m-widget24__title">Total Practical</h4><br>
    ...
    <script>
        ...
        $('.phase-attendance').click(function (e) {
            ...
            if ($(this).attr('data-loaded') == 0){
                ...
                $.get('{{route('students.attendance.phase', $student->id)}}', {phaseId: phaseId}, function (response) {
