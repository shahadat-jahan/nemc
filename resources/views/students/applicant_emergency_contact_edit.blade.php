<div class="row pl-4 pr-4">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('emergency_contact_name') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="emergency_contact_name" value="{{$student->emergencyContact->full_name}}" placeholder="Name"/>
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('emergency_contact_relation') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="emergency_contact_relation" value="{{$student->emergencyContact->relation}}" placeholder="Relation"/>
...
<div class="row pl-4 pr-4">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('emergency_phone') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="emergency_phone" value="{{$student->emergencyContact->phone}}" placeholder="Phone"/>
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('emergency_email') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="emergency_email" value="{{$student->emergencyContact->email}}" placeholder="Email"/>
...
<div class="row pl-4 pr-4">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <div class="form-group  m-form__group {{ $errors->has('emergency_address') ? 'has-danger' : '' }}">
            ...
            <textarea class="form-control m-input" name="emergency_address" rows="3" placeholder="Address">{{$student->emergencyContact->address}}</textarea>
