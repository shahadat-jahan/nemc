...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('admission_year') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input m_year_picker" name="admission_year" placeholder="Year"
                   readonly/>
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('full_name_bn') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="full_name_bn" placeholder="Full name"/>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('form_fillup_date') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input m_datepicker_1" name="form_fillup_date" placeholder="Form Fillup Date"/>
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('commenced_year') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input m_year_picker" name="commenced_year" placeholder="Year"
                   readonly/>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('test_score') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="test_score" placeholder="Test score"/>
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('merit_score') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="merit_score" placeholder="Merit score"/>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('merit_position') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="merit_position" placeholder="Merit position"/>
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('admission_roll_no') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="admission_roll_no" id="admission_roll_no" placeholder="Admission roll no"/>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('reg_no') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="reg_no" id="reg_no" placeholder="Registration number"/>
            @if ($errors->has('reg_no'))
                <div class="form-control-feedback">{{ $errors->first('reg_no') }}</div>
            @endif
        </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('student_id') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="student_id" id="student_id" placeholder="Student ID" readonly/>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('roll_no') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="roll_no" id="roll_no" placeholder="Roll number" />
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('user_id') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="user_id" id="user_id" placeholder="User ID" autocomplete="off" readonly/>
            {{--<div class="m-input-icon m-input-icon--left">
                <input type="text" class="form-control m-input" name="user_id" id="user_id" placeholder="User ID" style="padding-left: 2.1rem !important;">
                <span class="m-input-icon__icon m-input-icon__icon--left"><span style="line-height: 33px;">ST-</span></span>
            </div>--}}
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('password') ? 'has-danger' : '' }}">
            ...
            <input type="password" class="form-control m-input" name="password" placeholder="Password" value="{{old('password', '123456')}}" autocomplete="new-password" autocomplete="off"/>
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('date_of_birth') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input m_datepicker_1" name="date_of_birth" placeholder="Date of birth"/>
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('blood_group') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="blood_group" placeholder="Blood group"/>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('personal_remarks') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="personal_remarks" placeholder="Remarks"/>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('mobile') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="mobile" id="mobile" placeholder="Mobile"/>
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('email') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="email" id="email" placeholder="Email"/>
            @if ($errors->has('email'))
...
<div class="row foreign-row m--hide">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('embassy_contact_no') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="embassy_contact_no" placeholder="Embassy Contact Number"/>
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('passport_number') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="passport_number" placeholder="Passport number"/>
...
<div class="row foreign-row m--hide">
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="form-group  m-form__group {{ $errors->has('visa_duration') ? 'has-danger' : '' }}">
            ...
            <input type="text" class="form-control m-input" name="visa_duration" placeholder="Visa duration"/>
