                            ...
                            <div class="m-portlet m-portlet--full-height  ">
                                <div class="m-portlet__body">
                                    <div class="m-card-profile">
                                        ...
                                        <div class="m-card-profile__pic">
                                            <div class="m-card-profile__pic-wrapper">
                                                ...
                                                @else
                                                    <img src="{{asset('assets/global/img/male_avater.png')}}" alt="Applicant image">
                                                @endif
                                            </div>
                                        </div>
                                    ...
                                    <ul class="m-nav m-nav--hover-bg m-portlet-fit--sides">
                                        ...
                                        <li class="m-nav__item">
                                            <a class="m-nav__link active-link" href="{{route('students.card-item', [$student->id])}}">
                                                        ...
                                                        <div class="collapse" id="collapseStudentCardItems-{{Str::slug($subject->title,'-')}}">
                                                            ...
                                                            @foreach($cardItems[$subject->id]->groupBy('term_id')->sortKeys() as $termId => $cards)
                                                                ...
                                                                @foreach($cards as $card)
                                                                    ...
                                                                    //dd($itemPass);
                                                                    $percentage = !empty($itemDone) ? round(($itemPass * 100)/$itemDone, 2) : 0;
                                                                    ?>
                                                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                                    <div class="m-widget29 border mb-3">
                                                                        <a target="_blank" href="{{route('students.card-item-detail', [$student->id, $card->id])}}">
                                                                            <div class="m-widget_content">
                                                                                <h3 class="m-widget_content-title">{{$card->title}}</h3>
                                                                                <div class="m-widget_content-items">
                                                                                    <div class="m-widget_content-item">
                                                                                        <span class="text-center">Items</span>
                                                                                        <span class="m--font-brand text-center">{{$totalItem}}</span>
                                                                                    </div>
                                                                                    <div class="m-widget_content-item">
                                                                                        <span class="text-center">Completed</span>
                                                                                        <span class="text-center">{{$itemPass}}</span>
                                                                                    </div>
                                                                                    <div class="m-widget_content-item">
                                                                                        <span class="text-center">Taken</span>
                                                                                        <span class="text-center">{{$itemDone}}</span>
                                                                                    </div>
                                                                                    <div class="m-widget_content-item">
                                                                                        <span class="text-center">Percent</span>
                                                                                        <span class=" {{($percentage >= 75) ? 'm--font-accent' : 'm--font-danger'}}">{{$percentage}}%</span>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="text-center">
                                                                                <a class="btn btn-success btn-sm btn-block" target="_blank"
                                                                                    href="{{route('students.card-item-detail', [$student->id, $card->id])}}">
                                                                                    Show Items result
                                                                                </a>
                                                                            </div>
                                                                        </a>
