                ...
                <div class="m-portlet__head">
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text"><i class="fas fa-list-ul fa-md pr-2"></i>Student's ID Card</h3>
                        </div>
                    </div>
                    <div class="m-portlet__head-tools">
                        <a href="{{ URL::previous() }}" class="btn btn-primary m-btn m-btn--icon mr-1" title="Applicants"><i class="fa fa-undo-alt"></i> Back</a>
                        <a href="{{route('students.card.print', [$studentInfo->id])}}" class="btn btn-primary m-btn m-btn--icon" title="Applicants" target="_blank"><i class="fas fa-print"></i> Print ID Card</a>
                    </div>
                </div>
                                                        ...
                                                        <div class="col-sm-4 text-center">
                                                            <div class="image-box">
                                                                <div>
                                                                    ...
                                                                    @else
                                                                        <img class="student-img" src="{{getAvatar($studentInfo->gender)}}" alt="Applicant image">
                                                                    @endif
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="card  text-center card-bg-color" style="width: 34rem;">
                                                <div class="card-body card-back mt-3">
