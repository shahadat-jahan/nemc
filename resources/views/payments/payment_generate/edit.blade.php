            ...
            <div class="m-portlet">
                <div class="m-portlet__head">
                    ...
                    <div class="m-portlet__head-tools">
                        <a href="" class="btn btn-primary m-btn m-btn--icon" title="Class Absent Fee"><i class="far fa-credit-card"></i> Student Fee</a>
                    </div>
                </div>

                 <form class="m-form m-form--fit m-form--label-align-right" id="nemc-general-form" action="{{ route('generate.student.fee.update', $studentFeeInfo->id) }}" method="post"  enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                <div class="form-group m-form__group">
                                    ...
                                    <input type="text" class="form-control" name="student_id" value="{{$studentFeeInfo->student->full_name_en . ' (Roll No-'.$studentFeeInfo->student->roll_no. ')'}} " id="student_id" disabled>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                <div class="form-group m-form__group">
                                    <label class="form-control-label">Fee Title</label>
                                    <input type="text" class="form-control" name="title" value="{{$studentFeeInfo->title}}" id="title" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                <div class="form-group m-form__group">
                                    ...
                                    <input type="number" class="form-control" name="total_amount" value="{{$studentFeeInfo->total_amount}}" id="total_amount" placeholder="Total Amount" disabled>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                <div class="form-group m-form__group">
                                    <label class="form-control-label">Payable Amount</label>
                                    <input type="number" class="form-control" name="payable_amount" value="{{$studentFeeInfo->payable_amount}}" id="payable_amount" disabled>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                <div class="form-group m-form__group ">
                                    ...
                                    <input type="number" class="form-control" name="due_amount" value="{{$studentFeeInfo->due_amount}}" id="due_amount" placeholder="Total Amount" disabled>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                <div class="form-group m-form__group">
                                    <label class="form-control-label">Discount Amount</label>
                                    <input type="number" max="{{abs($studentFeeInfo->payable_amount)}}"  class="form-control" name="request_discount_amount" value="{{$studentFeeInfo->request_discount_amount}}" id="request_discount_amount">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <div class="form-group m-form__group ">
                                    ...
                                    <textarea class="form-control" name="remarks" id="remarks" rows="3" placeholder="Comment About Discount">{{$studentFeeInfo->remarks}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
