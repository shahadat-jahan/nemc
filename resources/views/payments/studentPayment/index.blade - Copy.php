                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{url('admin/collect_fee_invoice_pdf/'.$studentPayment->id.'/yes')}}" target="_blank" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="Dowanload"><i class="flaticon-download"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                        </tbody>
