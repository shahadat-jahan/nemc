                    ...
                    <div  style="position:relative;width:100%;padding-right:15px;padding-left:15px;-ms-flex:0 0 100%;flex:0 0 100%;max-width:100%;" >
                        ...
                        <div style="display:block;width:100%;overflow-x:auto;-webkit-overflow-scrolling:touch;">
                            <table style="border-collapse:collapse;width:100%;margin-bottom:1rem;color:#212529;border-width:0;">
                                <thead>
                                <tr>
                                    <th style="border-width:1px;border-style:solid;border-color:#dee2e6;padding-top:.75rem;padding-bottom:.75rem;padding-right:.75rem;padding-left:.75rem;border-top-width:1px;border-top-style:solid;border-top-color:#dee2e6;vertical-align:top;border-bottom-width:2px;border-bottom-style:solid;border-bottom-color:#dee2e6;">SI. No</th>
                                ...
                                @foreach($holidays as $key => $holiday)
                                    <tr>
                                        <th  style="border-width:1px;border-style:solid;border-color:#dee2e6;padding-top:.75rem;padding-bottom:.75rem;padding-right:.75rem;padding-left:.75rem;vertical-align:top;border-top-width:1px;border-top-style:solid;border-top-color:#dee2e6;">{{$key + 1}}</th>
                                        ...
                                        <td style="border-width:1px;border-style:solid;border-color:#dee2e6;padding-top:.75rem;padding-bottom:.75rem;padding-right:.75rem;padding-left:.75rem;vertical-align:top;border-top-width:1px;border-top-style:solid;border-top-color:#dee2e6;">{{!empty($holiday->from_date)? fulldateFormat($holiday->from_date) : 'N/A'}}</td>
                                        <td style="border-width:1px;border-style:solid;border-color:#dee2e6;padding-top:.75rem;padding-bottom:.75rem;padding-right:.75rem;padding-left:.75rem;vertical-align:top;border-top-width:1px;border-top-style:solid;border-top-color:#dee2e6;">{{!empty($holiday->to_date)? fulldateFormat($holiday->to_date) : 'N/A'}}</td>
                                    </tr>
                                @endforeach
                                @else
                                    <tr>
                                        <td  style="border-width:1px;border-style:solid;border-color:#dee2e6;padding-top:.75rem;padding-bottom:.75rem;padding-right:.75rem;padding-left:.75rem;vertical-align:top;border-top-width:1px;border-top-style:solid;border-top-color:#dee2e6; text-align: center;" colspan="4"><p class="text-center">No data found</p></td>
                                    </tr>
                                @endif
                                </tbody>
                            </table>
                            ...
                            <table style="border-collapse:collapse;width:100%;margin-bottom:1rem;color:#212529;border-width:0;">
                                ...
                                @foreach($classRoutines as $key => $classRoutine)
                                    <tr>
                                        ...
                                        <td style="border-width:1px;border-style:solid;border-color:#dee2e6;padding-top:.75rem;padding-bottom:.75rem;padding-right:.75rem;padding-left:.75rem;vertical-align:top;border-top-width:1px;border-top-style:solid;border-top-color:#dee2e6;">{{date("d/m/Y", strtotime($classRoutine->class_date))}}</td>
                                ...
                                @else
                                    <tr>
                                        <td  style="border-width:1px;border-style:solid;border-color:#dee2e6;padding-top:.75rem;padding-bottom:.75rem;padding-right:.75rem;padding-left:.75rem;vertical-align:top;border-top-width:1px;border-top-style:solid;border-top-color:#dee2e6; text-align: center;" colspan="7"><p class="text-center">No data found</p></td>
                                    </tr>
                                @endif
                                </tbody>
                            </table>
                    ...
                    <div  style="position:relative;width:100%;padding-right:15px;padding-left:15px;-ms-flex:0 0 100%;flex:0 0 100%;max-width:100%;" >
                        ...
                        <div style="display:block;width:100%;overflow-x:auto;-webkit-overflow-scrolling:touch;">
                            <table style="border-collapse:collapse;width:100%;margin-bottom:1rem;color:#212529;border-width:0;">
                                ...
                                @else
                                    <tr>
                                        <td  style="border-width:1px;border-style:solid;border-color:#dee2e6;padding-top:.75rem;padding-bottom:.75rem;padding-right:.75rem;padding-left:.75rem;vertical-align:top;border-top-width:1px;border-top-style:solid;border-top-color:#dee2e6; text-align: center;" colspan="5"><p class="text-center">No data found</p></td>
                                    </tr>
                                @endif
                                </tbody>
                            </table>
