...
@section('content')
    ...
    <div class="m-portlet m-portlet--tab">
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text"><i class="far fa-plus-square pr-2"></i>Create Student Group</h3>
                </div>
            </div>
        ...
        <!--begin::Form-->
        <form class="m-form m-form--fit m-form--label-align-right" action="{{ route('student_group.store') }}"
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group  m-form__group {{ $errors->has('department_id') ? 'has-danger' : '' }}">
                            ...
                            <select class="form-control department m-bootstrap-select m_selectpicker"
                                    name="department_id" id="department_id" data-live-search="true">
                        ...
                        <div
                            ...
                            <div class="m-checkbox-inline">
                                <label class="m-checkbox old_students">
                                    <input type="checkbox" id="is_old_students" name="is_old_students"
                                           class="is_old_students" value="1" checked> Yes
                                    <span></span>
                                </label>
                            </div>
                ...
                <div class="row roll_range m--hide">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group  m-form__group {{ $errors->has('roll_from') ? 'has-danger' : '' }}">
                            ...
                            <input type="number" class="form-control m-input item-title roll_from" name="roll_from"
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group  m-form__group {{ $errors->has('roll_to') ? 'has-danger' : '' }}">
                            ...
                            <input type="number" class="form-control m-input roll_to" name="roll_to"
                ...
                <div class="row">
                    <div class="roll col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group m-form__group  {{ $errors->has('rolls') ? 'has-danger' : '' }}">
                            ...
                            <select class="form-control rolls m-bootstrap-select m_selectpicker" id="roll"
                                    name="rolls[]"
    ...
    <script>
        ...
        $('#roll_range').change(function () {
            if ($('#roll_range').is(':checked')) {
                ...
                $('.m_selectpicker').selectpicker('deselectAll');
            } else {
                $(".roll_from").val("")
                $(".roll_to").val("")
                $('.roll_range').toggleClass('m--hide');
