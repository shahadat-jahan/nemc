...
@section('content')
    ...
    <div class="m-portlet m-portlet--tab">
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text"><i class="far fa-plus-square pr-2"></i>Create Holiday</h3>
                </div>
            </div>
        ...
        <!--begin::Form-->
        <form class="m-form m-form--fit m-form--label-align-right"  action="{{ url('admin/holiday') }}" method="post">
            @csrf
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group  m-form__group {{ $errors->has('title') ? 'has-danger' : '' }}">
                            ...
                            <input type="text" class="form-control m-input" name="title" value="{{ old('title') }}" placeholder="Holiday Title"/>
                            @if ($errors->has('title'))
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                        <div class="form-group  m-form__group {{ $errors->has('from_date') ? 'has-danger' : '' }}">
                            ...
                            <input type="text" class="form-control m-input m_datepicker_1" name="from_date"
                                   placeholder="Holiday start date" autocomplete="off" readonly/>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                        <div class="form-group  m-form__group">
                            ...
                            <input type="text" class="form-control m-input m_datepicker_1" name="to_date"
                                   placeholder="Holiday end date" autocomplete="off" readonly/>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group  m-form__group">
                            ...
                            <select class="form-control m-input m-bootstrap-select m_selectpicker" name="batch_type_id" data-live-search="true">
                                ...
                                @foreach($batchTypes as $batchType)
                                    <option value="{{$batchType->id}}" {{ old('batch_type_id') == $batchType->id ? 'selected' : '' }}>{{$batchType->title}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
