    ...
    <div class="container-fluid">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="mb-0">Update Admin User Permissions</h3>
                <a href="{{ url('admin/users') }}" class="btn btn-primary"><i class="fa fa-users pr-2"></i>Users</a>
            </div>
            <form action="{{ route('user.extra.permission') }}" method="post">
                @csrf
                <div class="card-body">
                            ...
                            @foreach (Config::get('menu') as $key => $val)
                                @php
                                    ...
                                    $readOnly =
                                        ...
                                        array_key_exists($key, $onlyUserGroupPermissions))
                                            ? 'disabled'
                                            : '';
                                @endphp
                                                    ...
                                                    @foreach ($val['children'] as $cKey => $cVal)
                                                        @php
                                                            ...
                                                            $cReadOnly =
                                                                ...
                                                                array_key_exists($cKey, $onlyUserGroupPermissions))
                                                                    ? 'disabled'
                                                                    : '';
                                                        @endphp
