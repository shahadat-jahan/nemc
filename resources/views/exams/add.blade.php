...
@section('content')
    <div class="m-portlet m-portlet--tab">
        ...
        <div class="card card-items exam-subjects mt-3 m--hide col-12 p-0" data-row="0">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                        <div
                            ...
                            <select class="form-control m-input subject_group" name="subject_group_id[0]"
                                    id="subject_group_id">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                        <div class="form-group  m-form__group {{ $errors->has('subject_id') ? 'has-danger' : '' }}">
                            ...
                            <select class="form-control m-input subject-list" name="subject_id[0]" id="subject_id">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 examType">
                        <div class="form-group  m-form__group {{ $errors->has('exam_type_id') ? 'has-danger' : '' }}">
                            ...
                            <select class="form-control m-input exam_types" name="exam_type_id[0]">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 cardExam m--hide">
                        <div class="form-group  m-form__group {{ $errors->has('card_id') ? 'has-danger' : '' }}">
                            ...
                            <select class="form-control m-input cards" name="card_id[0]">
                    ...
                    {{--                            <input type="text" class="form-control m-input exam_dates m_datepicker_1" name="exam_date[0]" placeholder="Date" autocomplete="off"/>--}}
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                        <div class="form-group  m-form__group {{ $errors->has('exam_time') ? 'has-danger' : '' }}">
                            ...
                            <input type="text" class="form-control m-input m_datetimepicker exam_times"
                                   name="exam_time[0]" placeholder="Time" autocomplete="off" readonly required/>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 written-option m--hide mt-5">
                        <div class="m-checkbox-inline pl-2">
                            <label class="m-checkbox">
                                <input type="checkbox" name="written_option[0]" value="1"> Configure Written Exam Group
                                ?
                                <span></span>
                            </label>
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 practical-option m--hide mt-5">
                        <div class="m-checkbox-inline pl-2">
                            <label class="m-checkbox">
                                <input type="checkbox" name="practical_option[0]" value="1"> Configure Practical Exam
                                Group ?
                                <span></span>
                            </label>
                        </div>
                ...
                <div class="written m--hide">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="form-group  m-form__group {{ $errors->has('exam_date') ? 'has-danger' : '' }}">
                                <label class="form-control-label"><span class="text-danger">*</span> Date </label>
                                <input type="text" class="form-control m-input m_datepicker_2 written_exam_date"
                                       name="written_exam_date[0][]" placeholder="Date" autocomplete="off"/>
                                @if ($errors->has('exam_date'))
                                    <div class="form-control-feedback">{{ $errors->first('exam_date') }}</div>
                                @endif
                            </div>
                ...
                <div class="practical m--hide">
                    <div class="d-flex justify-content-center text-danger">Please configure at least one sub-type &
                        student group!
                    </div>
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                            <div
                                ...
                                <select class="form-control m-input practical_exam_sub_type"
                                        name="practical_exam_sub_type[0][]">
                                    <option value="">---- Exam Sub Type ----</option>
                                </select>
                                @if ($errors->has('exam_sub_type'))
                                    <div class="form-control-feedback">{{ $errors->first('exam_sub_type') }}</div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                            <div
                                class="form-group  m-form__group {{ $errors->has('practical_student_groups') ? 'has-danger' : '' }}">
                                <label class="form-control-label"> Student Group </label>
                                <select class="form-control m-input student_groups"
                                        name="practical_student_groups[0][]">
                                    <option value="">---- Student Group ----</option>
                                </select>
                                @if ($errors->has('practical_student_groups'))
                                    <div
                                        class="form-control-feedback">{{ $errors->first('practical_student_groups') }}</div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                            <div class="form-group  m-form__group {{ $errors->has('exam_date') ? 'has-danger' : '' }}">
                                <label class="form-control-label"><span class="text-danger">*</span> Date </label>
                                <input type="text" class="form-control m-input m_datepicker_2 practical_exam_date"
                                       name="practical_exam_date[0][]" placeholder="Date" autocomplete="off"/>
                                @if ($errors->has('exam_date'))
                                    <div class="form-control-feedback">{{ $errors->first('exam_date') }}</div>
                                @endif
                            </div>
        ...
        <!--begin::Form-->
        <form class="m-form m-form--fit m-form--label-align-right" action="{{ route('exams.save') }}" method="post"
              id="nemc-general-form">
            @csrf
            <div class="m-portlet__body">
                <!--Top Common Form Start -->
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 m--hide">
                        <div class="form-group m-form__group {{ $errors->has('main_exam_id') ? 'has-danger' : '' }}">
                            <label class="form-control-label"><span class="text-danger">*</span> Main Exam </label>
                            <select class="form-control m-input m-bootstrap-select m_selectpicker"
                                    name="main_exam_id"
                                    id="main_exam_id" data-live-search="true">
                                <option value="">-- Select Exam --</option>
                            </select>
                            <span class="m-form__help text-info">If result not published or already supply exam created then can't find exam</span>
                            @if ($errors->has('main_exam_id') && old('exam_category_id') == 5)
                                <div class="form-control-feedback">
                                    {{ $errors->first('main_exam_id') }}
                                </div>
                            @endif
                        </div>
                    </div>
                ...
                <div class="row" id="all-subjects"></div>
...
@push('scripts')
    ...
    <script>
        var studentGroups = '';
        {{--var studentGroups = {!! $studentGroups !!};--}}
        ...
        $('#phase_id').change(function () {
            ...
            // selectedBatchGroup = _.filter(studentGroups, function(o) { return (o.session_id == sessionId) && (o.phase_id == phaseId) && (o.course_id == courseId); });
            // if (selectedBatchGroup.length > 0){
            //     for(s in selectedBatchGroup){
            //         if (selectedBatchGroup[s].department_id){
            //         $('.student_groups').append('<option value="'+selectedBatchGroup[s].id+'">'+selectedBatchGroup[s].group_name+' - '+ departments[selectedBatchGroup[s].department_id] +'</option>')
            //         }else {
        ...
        $('#exam_category_id').change(function () {
            if ($(this).val() == 5) {
                ...
                if (sessionId > 0 && courseId > 0 && phaseId > 0 && termId > 0) {
                    mApp.blockPage({
                        overlayColor: "#000000",
                        type: "loader",
                        state: "primary",
                    ...
                    $.get('{{route('exam.list.session.course.phase.term.type')}}', {
                        ...
                        $('.subject-row').addClass('m--hide');
                        $('.exam-subjects').remove();
                        if (response.exams) {
                            $('#main_exam_id').closest('.col-xs-12').removeClass('m--hide');
                            $('#main_exam_id').html('<option value="">-- Select Exam --</option>');
                            for (i in response.exams) {
                                exam = response.exams[i];
                                $('#main_exam_id').append('<option value="' + exam.id + '">' + exam.id + ' - ' + exam.title + '</option>')
                            }
                        }
                ...
                $('#main_exam_id').closest('.col-xs-12').addClass('m--hide');
                $('.subject-row').removeClass('m--hide');
            } else {
        ...
        $('.subject-list').change(function () {
            ...
            examType = current.parents('.exam-subjects').find('.exam_types');
        ...
        $('.exam_types').change(function () {
            ...
            if ($(this).val() == 1 || $(this).val() == 3) {
                ...
                current.parents('.exam-subjects').find('.m_datepicker_2').datepicker('destroy');
                ...
                $.get('{{route('exams.sub-types-list.subject')}}', {
                    ...
                    if (response.data) {
                        ...
                        if (current.val() == 1 || current.val() == 3) {
                            ...
                            //generate  practical Exam group
                            // selectedBatchGroup = _.filter(studentGroups, function(o) { return (o.session_id == sessionId) && (o.course_id == courseId) && (o.phase_id == phaseId); });
                            // current.parents('.exam-subjects').find('.practical').remove();
                        ...
                        current.parents('.exam-subjects').find(".m_datepicker_2").datepicker({
                            todayHighlight: !0,
        ...
        $('.written-option input:checkbox').click(function () {
            ...
            $(this).parents('.exam-subjects').find('.exam_dates').val('');
        });
        ...
        $('.add-subject').on('click', function () {
            ...
            examSubjectRow.find(".m_datepicker_1").datepicker({
                todayHighlight: !0,
                orientation: "bottom left",
                format: 'dd/mm/yyyy',
                autoclose: true,
            ...
            examSubjectRow.find(".m_datetimepicker").datetimepicker({
                format: "hh:ii",
                showMeridian: !0,
                todayHighlight: !0,
                autoclose: !0,
        ...
        // Custom method to validate practical student groups
        $.validator.addMethod("practicalStudentGroups", function (value, element, param) {
            var valid = true;
            $('[name^="practical_student_groups"]').each(function () {
                if (!$(this).val()) {
                    valid = false;
                    return false;
                }
        ...
        $('#nemc-general-form').validate({
            ...
            messages: {
                main_exam_id: {
                    required: 'The Main exam field is required when exam category is Supplementary.'
                },
            },
