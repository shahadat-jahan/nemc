    ...
    <div class="m-portlet m-portlet--tab">
        <div class="m-portlet__head">
            ...
            <div class="m-portlet__head-tools">
                <a href="{{ url('admin/notice_board') }}" class="btn btn-primary m-btn m-btn--icon"><i
                        class="fas fa-list-alt pr-2"></i>Notices</a>
            </div>
        </div>
            ...
            <div class="m-grid__item m-grid__item--fluid m-wrapper">
                <div class="m-content">
                    ...
                    @if(!empty($notice->file_path) && file_exists(public_path('nemc_files/noticeBoard/'.$notice->file_path)))
                        ...
                        <a href="{{asset('nemc_files/noticeBoard/'.$notice->file_path)}}" class="btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" target="_blank" title="Download" download><i class="fa fa-download"></i></a>
                        </div>
                    @endif
                </div>
            </div>
