...
@section('content')
    <div class="m-portlet m-portlet--tab">
        ...
        <!--begin::Form-->
        <form class="m-form m-form--fit m-form--label-align-right"  action="{{ route('frontend.student.password-change', $studentId) }}" id="nemc-general-form" method="post">
            @csrf
            ...
            <div class="m-portlet__foot m-portlet__foot--fit">
                <div class="m-form__actions text-center">
                    <a href="{{ url('nemc/students') }}" class="btn btn-outline-brand"><i class="fa fa-times"></i> Cancel</a>
