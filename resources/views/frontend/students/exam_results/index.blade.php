...
@push('style')
    <style>
        ...
        .dropdown-toggle::after, .btn.dropdown-toggle::after {
            content: "" !important;
        }
    </style>
@endpush
                ...
                <div class="m-portlet__head">
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text"><i
                                    class="fas fa-list-ul fa-md pr-2"></i>Student: {{$student->full_name_en}}</h3>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-9 col-lg-8 plr0">
                            <div class="m-portlet m-portlet--full-height m-portlet--tabs">
                                                            ...
                                                            <div class="m-dropdown__content">
                                                                <ul class="m-nav">
                                                                    <li class="m-nav__section m-nav__section--first">
                                                                        <span class="m-nav__section-text">Select Exam Category</span>
                                                                    </li>
                                                                    @foreach($examCategories as $key => $category)
                                                                        <li class="m-nav__item {{($categoryId == $key) ? 'active-link' : ''}}">
                                                                            <a href="#"
                                                                               class="m-nav__link change-category"
                                                                               data-exam-category-id="{{$key}}">
                                                                                <i class="m-nav__link-icon far fa-list-alt"></i>
                                                                                <span
                                ...
                                <div class="tab-content">
                                    @foreach($sessionPhases as $phase)
                                        <div
                                            class="tab-pane {{($phase->phase_id == $student->phase_id) ? 'active show' : ''}}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <table class="table table-bordered table-hover"
                                                                            ...
                                                                            @foreach($examSubjects[$subject->id] as $examSubject)
                                                                                <tr>
                                                                                    <th>
                                                                                        <a href="{{route('frontend.exam.subject.result.show', [$examSubject->exam->id, $examSubject->subject_id, $student->id])}}">{{$examSubject->exam->title}}</a>
                                                                                    </th>
                                                                                    <td>{{$examSubject->exam->term->title}}</td>
                                                                                    <td>
...
@push('scripts')
    ...
    <script>
        ...
        $('.change-category').click(function (e) {
            ...
            $.get('{{route('frontend.students.xam-result.phase', $student->id)}}', {
                phaseId: phaseId,
                cat_id: categoryId
            }, function (response) {
                template = $('#exam-results').html();
