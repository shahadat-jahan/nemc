...
@push('style')
    ...
    <style>
        ...
        /*#student-card-block-parent .student-card-block .col-md-12:nth-child(3), #student-card-block-parent .student-card-block .col-md-12:nth-child(4){
                                display: none;
                            }*/
    </style>
@endpush
    ...
    <div class="m-portlet">
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">
                        Name: {{ $student->full_name_en }} And Roll No: {{ $student->roll_no }}
                    </h3>
                </div>
            </div>
        </div>
        <div class="m-portlet__body">
            <div class="m-portlet  m-portlet--unair">
                <h5 class="text-center mb-4"><span class="border-bottom"> Basic Information</span></h5>
                <div class="m-portlet__body  m-portlet__body--no-padding p-0" id="student-card-block-parent"
                    style="padding: 0!important;">
                    <div class="row m-row--no-padding m-row--col-separator-xl student-card-block"
                        style="margin-left: -15px; margin-right: 15px;" id="student{{ $student->id }}-card-blocks"></div>
                </div>
                ...
                <div class="m-portlet__body" style="padding: 5px !important;">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="student-class-routine-today-{{ $student->id }}">
                            <thead>
                                <tr>
                ...
                <!--last 1 week class attendance start-->
                <div class="m-separator m-separator--dashed"></div>
                <h5 class="text-center mb-4"><span class="border-bottom">Last 1 week's (7 Days) Class Attendance</span></h5>
                <div class="m-portlet__body" style="padding: 5px !important;">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="student-class-routine-last-week-{{ $student->id }}">
                            <thead>
                                <tr>
                                    <th class="uppercase">Subject</th>
                                    <th class="uppercase">Class Type</th>
                                    <th class="uppercase">Class Date</th>
                ...
                <!--last 1 week class attendance end-->
                ...
                <!--Upcoming Exam start-->
                <div class="m-separator m-separator--dashed"></div>
                <h5 class="text-center mb-4"><span class="border-bottom"> Upcoming Exam (Next 1 Month)</span></h5>
                <div class="m-portlet__body" style="padding: 5px !important;">
                    <div class="table-responsive">
                ...
                <div class="m-separator m-separator--dashed"></div>
                <h5 class="text-center mb-4"><span class="border-bottom">Card Item Exam Information</span></h5>
                <div class="m-portlet__body" style="padding: 5px !important;">
...
@push('scripts')
                                ...
                                <div class="card my-2" id='student-@{{ studentId }}-subject-@{{ subjectId }}-card-@{{ id }}'>
                                    ...
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            ...
                                            @{{else}}
                                            <span class="badge badge-danger badge-pill" title="Not Clear"><i
    ...
    <script>
        ...
        //last 7 day's class routine with attendance for student
        function loadLastSevenDaysClassAttendance(studentId) {
            ...
            classRoutineId = 'student-class-routine-last-week-' + studentId;

            generateDatatable(classRoutineId, classRoutineTableColumns,
                baseUrl + 'nemc/dashboard/get-last-week-class-routine?student_id=' + studentId);
        }
        ...
        function loadDashboardModules() {
            ...
            loadLastSevenDaysClassAttendance(studentId);
        ...
        // hide student card block for payment
    </script>
@endpush
