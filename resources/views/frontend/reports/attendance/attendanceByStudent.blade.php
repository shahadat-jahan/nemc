                    ...
                    <div class="m-section__content">
                        <form id="nemc-general-form" role="form" method="get">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                    <select class="form-control m-bootstrap-select m_selectpicker" name="class_type_ids[]"
                                            title="---- Select Class Type ----" id="class_type_id" data-live-search="true" multiple>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-12 col-lg-12 col-xl-12">
                                    <div class="pull-right search-action-btn">
                                        @if(!empty($totalClass) && !empty($totalAttendance))
                                            <a target="_blank" href="{{route(customRoute('report.attendance.student.pdf'), [
                                        ...
                                        'class_type_ids' => app()->request->class_type_ids,
                                                ...
                                                PDF</a>
                                            <a href="{{route(customRoute('report.attendance.student.excel'), [
                                        'session_id' => app()->request->session_id,
                                        'course_id' => app()->request->course_id,
                                        'phase_id' => app()->request->phase_id,
                                        'term_id' => app()->request->term_id,
                                        ...
                                        <a href="{{ route(customRoute('report.attendance.student')) }}"
                                           class="btn btn-default reset"><i
                        ...
                        @if(!empty($totalClass))
                            <div class="row">
                                <div class="col-md-12">
                                    <h4 class="text-center">Student: {{$student->full_name_en}}(Roll
                                        No-{{$student->roll_no}})</h4>
    ...
    <script>
        ...
        $('.search-result').click(function () {
            ...
            $('#nemc-general-form select').each(function () {
                if (($(this).val() == '') && $(this).attr('name') != 'class_type_id') {
                    valid = false;
                }
            });
        ...
        $('#phase_id').change(function () {
            ...
            // load subject group
            $.get('{{route(customRoute('SubjectGroup.session.course.phase'))}}', {
                sessionId: sessionId,
                courseId: courseId,
                phaseId: phaseId
            }, function (response) {
        ...
        $('#subject_group_id').change(function () {
            ...
            // load subjects
            $.get('{{route(customRoute('subjects.group'))}}', {
                sessionId: sessionId,
                courseId: courseId,
        ...
        function makeStudentIdAndUserId(sessionId, courseId){
            if (courseId > 0 && sessionId > 0){
                ...
                $.get('<?php echo e(route(customRoute('student.info.session.course'))); ?>', {courseId: courseId, sessionId: sessionId}, function (response) {
