@extends('frontend.layouts.single-page')
        ...
        <div class="row">
            <div class="col-sm-6 offset-sm-3">
                <div class="card text-center">
                    <div class="card-body">
                        <form class="m-form m-form--fit m-form--label-align-right"  action="{{ route('frontend.user.change-password.post') }}" id="nemc-general-form" method="post">
                            @csrf
                            ...
                            <div class="m-portlet__foot m-portlet__foot--fit">
                                <div class="m-form__actions text-center">
                                    <a href="{{ route('frontend.user.cancel-password') }}" class="btn btn-secondary"><i class="fa fa-times"></i> Cancel</a>
