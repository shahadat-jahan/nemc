    ...
    <div class="m-portlet m-portlet--tab">
        <div class="m-portlet__head">
            ...
            <div class="m-portlet__head-tools">
                <a href="{{ url('nemc/holiday') }}" class="btn btn-primary m-btn m-btn--icon"><i class="fas fa-list-alt pr-2"></i>Holiday</a>
            </div>
        </div>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p>Status  : @if($holiday->status == 1) Active @else Inactive @endif </p>
                                </div>
                            </div>
                        </div>
                    </div>
