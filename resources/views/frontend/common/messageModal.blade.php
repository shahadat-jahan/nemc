<div class="modal fade" id="sendMessageUserMpdal" role="dialog">
    <div class="modal-dialog" role="document">
        <form class="m-form m-form--fit m-form--label-align-right form-validation"  action="{{ route('frontend.message.store') }}" method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <div class="form-group  m-form__group ">
                                ...
                                <textarea type="text" class="form-control m-input summernote" name="message" placeholder="Your Message" rows="2" style="height: 5rem !important;"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
@push('scripts')
    <script>
        ...
        $(document).on('click', '.send-message-user', function (e) {
            ...
            $('#sendMessageUserMpdal').modal('show');
