                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                    <input type="text" class="form-control m-input m_datepicker" name="start_date"
                                           value="{!! app()->request->start_date !!}" id="start_date"
                            ...
                            <div class="row my-3">
                                <div class="col-xs-12 col-sm-6 col-md-12 col-lg-12 col-xl-12">
                                    <div class="pull-right search-action-btn">
                                        @if(!empty($attendanceReport) && $attendanceReport->isNotEmpty())
                                            <a target="_blank" href="{{route('report.attendance.pdf', [
                                        ...
                                        'end_date' => app()->request->end_date,
                                                ...
                                                PDF</a>
                                            <a href="{{route('report.attendance.excel', [
                                        'session_id' => app()->request->session_id,
                                        'course_id' => app()->request->course_id,
                                        'phase_id' => app()->request->phase_id,
                                        'subject_group_id' => app()->request->subject_group_id,
                                        ...
                                        <a class="btn btn-default m-btn m-btn--icon"
                                           href="{{url('admin/report_attendance')}}"><i
...
@push('scripts')
    ...
    <script>
        ...
        // Maintain class type selection after page load
        var selectedClassTypes = {!! json_encode(app()->request->class_type_ids ?? []) !!};
        if (selectedClassTypes && selectedClassTypes.length > 0) {
            $('#class_type_id').selectpicker('val', selectedClassTypes);
        }
        ...
        let subjectId = '{{ app()->request->subject_id }}';
