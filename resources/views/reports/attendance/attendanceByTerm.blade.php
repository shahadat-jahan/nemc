                    ...
                    <div class="m-section__content">
                        <form id="nemc-general-form" role="form" method="get">
                            ...
                            <div class="row">
                                ...
                                {{--                               <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">--}}
                                {{--                                    <select class="form-control m-input"  name="term_id">--}}
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                    <select class="form-control m-bootstrap-select m_selectpicker" name="subject_group_id" id="subject_group_id" data-live-search="true">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                    <input type="text" class="form-control m-input m_datepicker" name="start_date" value="{!! app()->request->start_date !!}" id="start_date" placeholder="Start Date" autocomplete="off" aria-describedby="start_date-error" aria-invalid="false">
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                    <input type="text" class="form-control m-input m_datepicker" name="end_date" value="{!! app()->request->end_date !!}" id="end_date" placeholder="End Date" autocomplete="off" aria-describedby="end_date-error" aria-invalid="false">
                                </div>
                            ...
                            <div class="row my-3">
                                <div class="col-xs-12 col-sm-6 col-md-12 col-lg-12 col-xl-12">
                                    <div class="pull-right search-action-btn">
                                        @if(!empty($attendanceReport) && (!empty($totalLectureClass) || !empty($totalPracticalClass)))
                                            <a target="_blank" href="{{route('report.attendance.term.pdf', [
                                        ...
                                        'end_date' => app()->request->end_date,
                                                ...
                                                PDF</a>
                                            <a href="{{route('report.attendance.term.excel', [
                                        'session_id' => app()->request->session_id,
                                        'course_id' => app()->request->course_id,
                                        'phase_id' => app()->request->phase_id,
                                        'term_id' => app()->request->term_id,
                                        ...
                                        <a class="btn btn-default m-btn m-btn--icon" href="{{url('admin/report_attendance_by_term')}}"><i
                                    ...
                                    <div class="m-table table-responsive">
                                        <table class="table table-bordered table-hover sticky-header">
                                            ...
                                            <tr>
                                                ...
                                                <th colspan="4" class="text-center">Lecture</th>
                                                <th colspan="4" class="text-center">Tutorial & Other</th>
                                            ...
                                            @foreach($attendanceReport as $attendance)
                                                ...
                                                @endphp
                                                <tr>
                                                    <th class="text-center">{{$attendance->student->roll_no}}</th>
...
@push('scripts')
    ...
    <script>
        ...
        $('#phase_id').change(function () {
            ...
            // load subject group
            $.get('{{route('SubjectGroup.session.course.phase')}}', {sessionId: sessionId, courseId: courseId, phaseId: phaseId}, function (response) {
                if (response.data){
