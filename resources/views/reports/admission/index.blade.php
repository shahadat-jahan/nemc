            ...
            <div class="m-portlet">
                ...
                <div class="m-portlet__body">
                    ...
                    <div class="m-section__content">
                        <div class="row">
                            <div class="col-md-3">
                                <a href="{{route('report.admission.type', [1])}}">
                            ...
                            <div class="col-md-3">
                                <a href="{{route('report.admission.type', [3])}}">
                                    <div class="m-stack m-stack--ver m-stack--general m-stack--demo">
                                        <div class="m-stack__item m-stack__item--center">Insolvent & Meritorious<br>Students
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="col-md-3">
                                <a href="{{route('report.admission.type', [2])}}">
                                    <div class="m-stack m-stack--ver m-stack--general m-stack--demo">
                            ...
                            <div class="col-md-3">
                                <a href="{{route('report.admission.type', 'all')}}">
                                    <div class="m-stack m-stack--ver m-stack--general m-stack--demo">
