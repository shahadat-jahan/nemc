                                    ...
                                    <div class="col-md-12">
                                        <div class="pull-right search-action-btn">
                                            @if(isset($searchResult) && !empty($searchResult->toArray()))
                                                <a href="{{route('report.student.admission.excel.type', ['all', 'session_id' => $sessionId, 'course_id' => $courseId])}}" class="btn btn-brand m-btn m-btn--icon"><i class="fa fa-file-export"></i> Export</a>
                                                <a href="{{route('report.student.admission.print.type', ['all', 'session_id' => $sessionId, 'course_id' => $courseId])}}" class="btn btn-info m-btn m-btn--icon" target="_blank"><i class="fa fa-print"></i> Print</a>
                                            @endif
