                ...
                <div class="m-portlet__body">
                    <div class="m-section__content">
                        <form id="searchForm" role="form" method="get"
                            action="{{ route('report.student.admission.type', [1]) }}">
                            <div class="form-body">
                                <div class="row">
                                        ...
                                        <div class="pull-right search-action-btn">
                                            @if (isset($searchResult) && !empty($searchResult->toArray()))
                                                <div class="btn-group" data-hover="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right w-100">
                                                        <a class="dropdown-item"
                                                            href="{{ route('report.student.admission.print.type', array_merge([1, 'session_id' => $sessionId, 'course_id' => $courseId], ['page_layout' => 'A4-landscape'])) }}"
                                                            target="_blank">
                                                            <i class="fas fa-arrows-alt-h"></i> Landscape
                                                        </a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('report.student.admission.print.type', array_merge([1, 'session_id' => $sessionId, 'course_id' => $courseId], ['page_layout' => 'A4-portrait'])) }}"
                                                            target="_blank">
                                                ...
                                                <a class="btn btn-primary m-btn m-btn--icon"
                                                    href="{{ route('report.student.admission.excel.type', [1, 'session_id' => $sessionId, 'course_id' => $courseId]) }}"
                                                    class="btn btn-brand m-btn m-btn--icon"><i
