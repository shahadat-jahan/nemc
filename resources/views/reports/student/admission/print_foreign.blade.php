...
@section('content')
    ...
    <div style="text-align: center">
        Statement showing the particular of the candidates appplied for admission i the 1st year {{$courseText}} course (Foreign Quota) of North East Medical College in the session {{$sessionText}}
    </div>
    <br>
    ...
    <table class="table table-bordered table-hover" id="dataTable"  style="box-sizing:border-box;border-collapse:collapse;border-width:1px;border-style:solid;border-color:#f4f5f8;width:100%;margin-bottom:0 !important;background-color:rgba(0,0,0,0);">
        ...
        <tr style="box-sizing:border-box;">
            ...
            <th colspan="4" style="border-bottom-width: 2px;vertical-align: bottom;border-bottom: 2px solid #dee2e6;border: 1px solid #f4f5f8;padding: .75rem;">A Level / Similar</th>
            <th colspan="5" style="border-bottom-width: 2px;vertical-align: bottom;border-bottom: 2px solid #dee2e6;border: 1px solid #f4f5f8;padding: .75rem;">O Level / Similar</th>
            ...
            @if(!empty($searchResult))
                ...
                @foreach($searchResult as $student)
                    ...
                    <tr style="box-sizing:border-box;">
                        ...
                        <td style="box-sizing:border-box;border-width:1px;border-style:solid;border-color:#f4f5f8;padding-top:.2rem !important;padding-bottom:.2rem !important;padding-right:.75rem;padding-left:.75rem;vertical-align:top;border-top-width:1px;border-top-style:solid;border-top-color:#f4f5f8;">{{$aLevel->educationBoard->title}}</td>
                        ...
                        <td style="box-sizing:border-box;border-width:1px;border-style:solid;border-color:#f4f5f8;padding-top:.2rem !important;padding-bottom:.2rem !important;padding-right:.75rem;padding-left:.75rem;vertical-align:top;border-top-width:1px;border-top-style:solid;border-top-color:#f4f5f8;">{{$oLevel->educationBoard->title}}</td>
        ...
        <tfoot>
        <tr>
            <th colspan="14" rowspan="4" style="text-align: left">
