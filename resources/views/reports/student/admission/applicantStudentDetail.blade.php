            ...
            <div class="m-portlet view-page">
                <div class="m-portlet__head">
                    ...
                    <div class="m-portlet__head-tools">
                        ...
                        <a target="_blank" href="{{route('admission.student.single.print', $student->id)}}" class="btn btn-primary m-btn m-btn--icon" title="Applicants"><i class="fas fa-print"></i> Print</a>
                    </div>
                </div>
                ...
                <div class="m-portlet__body border m-3" style="padding: 0 !important">
                    ...
                    <hr class="m-0">
                    @php
                        $studentSscEducationInfo = $student->educations()->where('education_level', 1)->first();
                        $studentHscEducationInfo = $student->educations()->where('education_level', 2)->first();
                    @endphp
                    <div class="row">
