...
<head>
    ...
    <title>Foreign Students Admission Report</title>
    <style>
        body {
...
<div class="container">
    <div class="brand-section">
        ...
        <div style="margin-top: -40px" class="text-center">
            ...
            <h3>Foreign Students Admission Report</h3>
            <p>Statement showing the particular of the candidates applied for admission in the 1st year {{$courseText}} course <br> (Foreign Quota) of North East Medical College in the session {{$sessionText}}</p>
    ...
    <table class="table">
        ...
        @if(isset($searchResult))
            @if(!empty($searchResult))
                ...
                @endforeach
            @else
                <tr><td colspan="25" align="center">No data found</td></tr>
            @endif
        @endif
        </tbody>
    </table>
