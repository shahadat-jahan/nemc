...
<head>
    ...
    <title>All Students Admission Report</title>
    <style>
        body {
    ...
    <div class="container">
        <div class="brand-section">
            ...
            <div style="margin-top: -40px" class="text-center">
                ...
                <h3>All Students Admission Report</h3>
                <p>Statement showing the particular of the candidates applied for admission in the 1st year {{$courseText}} course <br> (Normal, Foreign, Insolvent & Meritorious) of North East Medical College in the session {{$sessionText}}</p>
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th rowspan="2">Student Category</th>
