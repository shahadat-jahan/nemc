                ...
                <form class="m-form m-form--label-align-left- m-form--state-" id="m_form">
                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="wizard-step" id="step_1">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="m-radio-list pt-2">
                                        <label class="m-radio m-radio--solid m-radio--brand">
                                            <input type="radio" name="channel" value="sms" checked> SMS
                                            <span></span>
                                        </label>
                                        <label class="m-radio m-radio--solid m-radio--brand">
                            ...
                            <div class="form-group m-form__group d-none row" id="subject_container">
                                <div class="col-md-3">
                            ...
                            <div class="form-group m-form__group">
                                ...
                                <textarea name="message" id="campaign_message" class="form-control m-input" rows="5"
                                          placeholder="Enter your campaign message here..." required></textarea>
                                    ...
                                    <div class="col-lg-4">
                                        <label class="m-checkbox m-checkbox--solid m-checkbox--brand">
                                            <input type="checkbox" name="recipients[]" value="students"
                                                   class="recipient-toggle" data-target="#student_filters"> Students
                                            <span></span>
                                        </label>
                                    </div>
                                    <div class="col-lg-4">
                                        <label class="m-checkbox m-checkbox--solid m-checkbox--brand">
                                            <input type="checkbox" name="recipients[]" value="teachers"
                                                   class="recipient-toggle" data-target="#teacher_filters"> Teachers
                                            <span></span>
                                        </label>
                                    </div>
                                    <div class="col-lg-4">
                                        <label class="m-checkbox m-checkbox--solid m-checkbox--brand">
                                            <input type="checkbox" name="recipients[]" value="guardians"
                                                   class="recipient-toggle" data-target="#guardian_filters"> Guardians
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="wizard-step d-none" id="step_3">
                            ...
                            <div class="form-group m-form__group">
                                ...
                                <div class="m-radio-list pt-2">
                                    ...
                                    <label class="m-radio m-radio--solid m-radio--brand">
                                        <input type="radio" name="status" value="scheduled" class="status-radio">
                                        Schedule
                                        for Later
                                        <span></span>
                                    </label>
                                    <label class="m-radio m-radio--solid m-radio--brand">
                                        <input type="radio" name="status" value="draft" class="status-radio"> Save as
                                        Draft
                                        <span></span>
                                    </label>
                                </div>
                            </div>
                            <div class="form-group m-form__group d-none row" id="schedule_datetime_container">
                                <div class="col-md-3">
                        ...
                        <div class="wizard-step d-none" id="step_4">
                            <div class="m-form__heading">
                                <h3 class="m-form__heading-title">Step 4: Review & Send</h3>
                            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.m-wizard__step-info').on('click', function (e) {
                ...
                // For create, only allow jumping to steps already visited or the next step if valid
            ...
            // Toggle Schedule Input based on Status
            ...
            // Toggle Subject Input based on Channel
            ...
            // Toggle filters based on recipient selection
            ...
            $submitBtn.on('click', function () {
                ...
                $submitBtn.prop('disabled', true).html('<span><i class="la la-refresh la-spin"></i>&nbsp;&nbsp;<span>Sending...</span></span>');
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.success) {
                            ...
                            $submitBtn.prop('disabled', false).html('<span><i class="la la-check"></i>&nbsp;&nbsp;<span>Launch Campaign</span></span>');
                        }
                    },
                    error: function (xhr) {
