...
@section('content')
    <div class="m-portlet m-portlet--tab">
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text"><i class="far fa-plus-square pr-2"></i>Add Class Routine Schedule
                    </h3>
                </div>
            </div>
        ...
        <form class="m-form m-form--fit m-form--label-align-right" action="{{ route('class_routine.store') }}"
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group  m-form__group {{ $errors->has('phase_id') ? 'has-danger' : '' }}">
                            ...
                            <select class="form-control m-input" name="phase_id" id="phase_id">
                                <option value="{{ old('phase_id') }}">---- Select Phase ----</option>
                            </select>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group  m-form__group {{ $errors->has('term_id') ? 'has-danger' : '' }}">
                            ...
                            <select class="form-control m-input" name="term_id" id="term_id">
                                <option value="{{ old('term_id') }}">---- Select Term ----</option>
                            </select>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group  m-form__group {{ $errors->has('subject_id') ? 'has-danger' : '' }}">
                            ...
                            <select class="form-control m-input" name="subject_id" id="subject_id">
                                <option value="{{ old('subject_id') }}">---- Select Subject ----</option>
                            </select>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group  m-form__group {{ $errors->has('class_type_id') ? 'has-danger' : '' }}">
                            ...
                            <select class="form-control m-bootstrap-select m_selectpicker" data-live-search="true" name="class_type_id"
                                id="class_type_id">
                                <option value="">---- Select Type ----</option>
                                {!! select($classTypes, old('class_type_id')) !!}
                            </select>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group  m-form__group {{ $errors->has('batch_type_id') ? 'has-danger' : '' }}">
                            ...
                            <select class="form-control m-bootstrap-select m_selectpicker" name="batch_type_id" id="batch_type_id">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group  m-form__group {{ $errors->has('end_date') ? 'has-danger' : '' }}">
                            ...
                            <input type="text" class="form-control m-input m_datepicker"
                                value="{{ old('end_date') }}" name="end_date" id="end_date" placeholder="End Date"
                                autocomplete="off" readonly />
                            <span class="m-form__help text-warning">The end date must not be more than 40 days after the start date.</span>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group  m-form__group {{ $errors->has('start_time') ? 'has-danger' : '' }}">
                            ...
                            <input type="text" class="form-control m-input m_datetimepicker" name="start_time"
                                id="start_time" placeholder="Start Time" autocomplete="off" readonly />
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group  m-form__group {{ $errors->has('end_time') ? 'has-danger' : '' }}">
                            ...
                            <input type="text" class="form-control m-input m_datetimepicker" name="end_time"
                                id="end_time" placeholder="End Time" autocomplete="off" readonly />
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group  m-form__group {{ $errors->has('hall_id') ? 'has-danger' : '' }}">
                            ...
                            <select class="form-control m_selectpicker" data-live-search="true" name="hall_id"
                                id="hall_id">
                                <option value="">---- Select Class Room ----</option>
                                {!! select($classRooms, old('hall_id')) !!}
                            </select>
                            ...
                            <div class="m-checkbox-inline">
                                <label class="m-checkbox">
                                    <input type="checkbox" name="is_old_studnets" class="is_old_students"
                                        id="is_old_students" value="1" checked> Yes
                                    <span></span>
                                </label>
                            </div>
                            @if ($errors->has('days'))
            ...
            <div class="m-portlet__foot m-portlet__foot--fit" style="margin-left: 6px;">
                <div class="m-form__actions text-center">
                    <a href="{{ URL::previous() }}" class="btn btn-outline-brand"><i class="fa fa-times"></i>
                        Cancel</a>
                    <button type="submit" id="submitButton" class="btn btn-success"><i class="fa fa-save"></i> Save
                    </button>
                </div>
            </div>
        </form>
...
@push('scripts')
    ...
    <script>
        ...
        function getPhases(sessionId, courseId) {
            if (sessionId != '' && courseId != '') {
                ...
                $.get('{{ route('phase.term.list') }}', {
                    ...
                    if (response.data) {
                        $('#phase_id').html('<option value="">---- Select Phase ----</option>');
                        phaseInfo = response.data;
                        console.log(phaseInfo);
                        console.log('last');
                        for (i in phaseInfo) {
                            $('#phase_id').append('<option value="' + phaseInfo[i].phase.id + '">' + phaseInfo[i]
                                .phase.title + '</option>')
                        }
                    }
                    mApp.unblockPage();
            ...
            $.get('{{ route('subjects.session.course.phase') }}', {
                ...
                if (response.data) {
                    ...
                    for (i in response.data) {
                        ...
                        $('#subject_id').append('<option value="' + subject.id + '">' + subject.title +
                            '</option>')
                    }
                }
                mApp.unblockPage();
        ...
        $('#class_type_id').change(function(e) {
            ...
            if (classTypeId != 0 && classTypeId != 1 && classTypeId != 9 && classTypeId != 17) {
        ...
        $('#nemc-general-form').validate({
            ...
            invalidHandler: function() {
                $("#submitButton").prop("disabled", false).html('<i class="fa fa-save"></i> Save').css('cursor', 'pointer');
            }
        });
    </script>
@endpush
