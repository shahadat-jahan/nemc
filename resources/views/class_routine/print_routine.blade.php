            ...
            <div class="m-portlet">
                <div class="m-portlet__head">
                    ...
                    <div class="m-portlet__head-tools">
                        <a href="{{ url()->previous() }}" class="btn btn-primary m-btn m-btn--icon"><i class="fas fa-undo-alt pr-2"></i>Back</a>
                    </div>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 col-xl-3">
                                    <div class="pull-right search-action-btn">
                                        ...
                                        @if(!empty(app()->request->session_id) && !empty(app()->request->course_id))
                                            <a href="{{ route('class_routine.file.print', ['session_id' => app()->request->session_id, 'course_id' => app()->request->course_id]) }}" target="_blank" class="btn btn-primary m-btn m-btn--icon"><i class="fas fa-print"></i> Print</a>
                                        @else
                                            <a href="{{ route('class_routine.file.print') }}" target="_blank" class="btn btn-primary m-btn m-btn--icon"><i class="fas fa-print"></i> Print</a>
                                        @endif
