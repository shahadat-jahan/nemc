...
@section('content')
    <div class="row">
        {{-- route(customRoute('class_routine.info.single'), $classRoutine->id)--}}
        <div class="col-md-12">
            <div class="m-portlet view-page">
                <div class="m-portlet__head">
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text"><i class="fa fa-calendar-alt fa-md pr-2"></i>Class Routine
                                (Calendar)</h3>
                        </div>
                    </div>
                    <div class="m-portlet__head-tools">
                        <a href="{{ route('class_routine.list') }}" class="btn btn-primary m-btn m-btn--icon mr-2"><i
                ...
                <div class="m-portlet__body">
                    <form class="mb-3" id="searchForm" action="{{route('class_routine.calendar')}}" role="form"
                          method="get">
                        <div class="form-body">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-right search-action-btn">
                                        ...
                                        <a href="{{ route('class_routine.calendar') }}" class="btn btn-default reset"><i
...
@push('scripts')
    <script src="//cdnjs.cloudflare.com/ajax/libs/fullcalendar/3.10.0/fullcalendar.min.js"
