                ...
                <div class="m-portlet__head">
                    ...
                    <div class="m-portlet__head-tools">
                        @if (hasPermission('topic/create'))
                            <a href="{{route('assign.topic.form') }}" class="btn btn-primary m-btn m-btn--icon mr-2"><i
                                    class="fas fa-tag pr-2"></i>Assign Topic</a>
                            <a href="{{route('topic.create') }}" class="btn btn-primary m-btn m-btn--icon"><i
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                    <div class="form-group">
                                        <select class="form-control m-bootstrap-select m_selectpicker"
                                                name="topic_head_id" id="topic_head_id" data-live-search="true">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                    <div class="form-group">
                                        <select class="form-control m-input m-bootstrap-select m_selectpicker"
                                                name="teacher_id" id="teacher-id" data-live-search="true">
