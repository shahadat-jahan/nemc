...
@section('content')
    <div class="m-portlet m-portlet--tab">
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">Create User Group</h3>
                </div>
            </div>
        ...
        <!--begin::Form-->
        <form class="m-form m-form--fit m-form--label-align-right"  action="{{ url('admin/user_groups') }}" method="post">
            @csrf
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group m-form__group {{ $errors->has('group_name') ? 'has-danger' : '' }}">
                            ...
                            <input type="text" class="form-control md-input" name="group_name" value="{{ old('group_name') }}" placeholder="Group Name" />
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group m-form__group {{ $errors->has('description') ? 'has-danger' : '' }}">
                            ...
                            <input type="text" class="form-control md-input" name="description" value="{{ old('description') }}" placeholder="Description" />
