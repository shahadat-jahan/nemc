            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green-sharp sbold uppercase">edit page</span>
                    </div>
                    <div class="actions">
                        ...
                        <form role="form" action="{{ url('admin/pages/'.$page->id) }}" method="post">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group {{ $errors->has('meta_description') ? 'has-error' : '' }}">
                                    ...
                                    <textarea name="meta_description" id="" rows="5" class="form-control"
                                ...
                                <div class="form-group {{ $errors->has('content') ? 'has-error' : '' }}">
                                    ...
                                    <textarea name="content" id="" rows="20" class="form-control text-editor" placeholder="Page content">{{ old('content', $page->content) }}</textarea>
                                    <span class="help-block">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <div class="text-center">
                                            <button type="submit" name="status" value="0" class="btn btn-default btn-rounded"><i class="fa fa-pencil-square"></i> Update and <strong>Draft</strong></button>
                                            <button type="submit" name="status" value="1" class="btn btn-save btn-rounded"><i class="fa fa-share-square"></i> Update and <strong>Publish</strong></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
